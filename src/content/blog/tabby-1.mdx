---
title: 'Tabby: Exploring Tabular Libraries Under The Hood | Part 1 - Data Structures and Memory'
description: 'A small implementation of a pyarrow/pandas/polars like librairies to better understand how they work and how they can be optimized.'
pubDate: 'May 10 2025'
...
During my first Jira ticket, I realized early on that we operate on large datasets.
In fact, I quickly encountered dataframes approaching the 100s of GBs, which is a lot more than many personal computers or VMs can handle.
...
I also realized that I don't know much about how data science libraries like Pandas work.
I have taken filters, selects, joins, aggregations for granted but I don't really understand what goes into making these work.
Of course, the algorithms used matter, but how can these operations be run fast on current hardware?
...
Then, I'll some optimizations techniques such as multithreading, SIMD, and perhaps CUDA too to see how much more speed⚡🚀💨 I can get.
...
## Basic DataFrame Implementation
Now that we have looked at how a dataframe is represented across Pandas and Polars, let's write out the basic classes in their essential fields.
