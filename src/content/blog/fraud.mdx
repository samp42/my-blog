...
The data is high quality, exempt of missing values, and structured with features representing transaction details, user behavior, and labels indicating fraudulent activity.
...
- Number of transactions of the same amount in a single step, 24 steps (1 day), 168 steps (1 week), all steps (1 month)
- Number of transactions by a sender in a single step, 24 steps, 168 steps, all steps
- Number of transactions by a receiver in a single step, 24 steps, 168 steps, all steps
- Number of transactions an individual is involved in in a single step, 24 steps, 168 steps, all steps
- Number of unique receivers per sender in a single step, 24 steps, 168 steps, all steps
- Number of unique senders per receiver in a single step, 24 steps, 168 steps, all steps
- Total amount received by an individual in a single step, 24 steps, 168 steps, all steps
